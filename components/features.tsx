...
export default async function Hero() {
    const features: Feature[] = [
        ...
        },
        {
            ...
            images: [
                "/screenshots/feature-hotkeys-1.png",
            ],
        },
        {
            ...
            images: [
                "/screenshots/feature-customization-1.png",
                "/screenshots/feature-customization-2.png",
                "/screenshots/feature-customization-3.png",
                "/screenshots/feature-customization-4.png",
                "/screenshots/feature-customization-5.png",
                "/screenshots/feature-customization-6.png",
                "/screenshots/feature-customization-7.png",
            ],
        },
        {
            ...
            images: [
                "/screenshots/feature-scenes-1.png",
                "/screenshots/feature-scenes-2.png",
                "/screenshots/feature-scenes-3.png",
            ],
        },
        {
            ...
            images: [
                "/screenshots/feature-motionsensors-1.png",
                "/screenshots/feature-motionsensors-2.png",
                "/screenshots/feature-motionsensors-3.png",
            ],
        },
        {
            ...
            images: [
                "/screenshots/feature-switches-1.png",
                "/screenshots/feature-switches-2.png",
            ],
        },
        {
            ...
            images: [
                "/screenshots/feature-ruleeditor-1.png",
                "/screenshots/feature-ruleeditor-2.png",
                "/screenshots/feature-ruleeditor-3.png",
            ],
        },
        {
            ...
            images: [
                "/screenshots/feature-shortcuts-1.png",
            ],
        },
        {
            ...
            images: [
                "/screenshots/feature-multibridge-1.png",
                "/screenshots/feature-multibridge-2.png",
            ],
        },
        {
    ...
    return (
        <section className="bg-tertiary-dark" aria-label="We Love Lights Features">
            <div className="flex flex-col items-center gap-5 top-[51px]">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 xs:gap-8 px-5">
