                    ...
                    >
                        ...
                        <Button
                            variant="ghost"
                                ...
                                onClick={() => window.location.href = 'https://we-love-lights.userjot.com/board/bugs/'}
                        >
                            <BugIcon />
                            <span>File a Bug</span>
                        </Button>

                            <Button variant="ghost" className="w-full rounded-3xl gap-3 justify-start hover:bg-primary/40 hover:text-black/95 cursor-pointer" onClick={() => window.location.href = 'https://we-love-lights.userjot.com/board/features/'}>
